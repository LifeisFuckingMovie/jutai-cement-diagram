...
import { flowData, flowDataAnchors, flowDataIconRect, flowDataTextRect } from './shuibeng';
...
export function register() {
  registerNode('flowShuibeng', flowData, flowDataAnchors, flowDataIconRect, flowDataTextRect);
